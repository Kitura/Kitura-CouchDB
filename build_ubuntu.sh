...
docker run --rm -e KITURA_BRANCH=$TRAVIS_BRANCH -v $TRAVIS_BUILD_DIR:/root/Kitura-CouchDB ibmcom/kitura-ubuntu:latest /root/Kitura-CouchDB/build_docker_cmd.sh
